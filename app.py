    ...
    def run_consent(self):
        ...
        with self.container_captcha.container():
            ...
            st.markdown(">**Study Title:** Trust in Robotic Aided Decisions  "
                        ...
                        "  \nYou will be given $3 for completing the experiment. Additionally, you may be eligible for extra rewards up to $2 based on your performance in a game. The game's performance is measured by the time it takes for you to select the correct solution to the puzzle."
